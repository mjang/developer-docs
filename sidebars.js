...
const sidebars = {
  ...
  mainSidebar: [
    ...
    },
    {
      ...
      items: ["try-it-out/try-it-out-hosted", "try-it-out/try-it-out-embedded"],
    },
    /*
    {
      type: 'category',
...
*/
  ...
  sdkSidebar: [
    ...
    },
    {
      ...
      collapsible: true,
      items: [
        "sdks/embedded-reference-guide/reference-initialize",
        "sdks/embedded-reference-guide/reference-isBindPasskeyUrl",
        "sdks/embedded-reference-guide/reference-bindPasskey",
        "sdks/embedded-reference-guide/reference-isAuthenticateUrl",
        "sdks/embedded-reference-guide/reference-authenticate",
        "sdks/embedded-reference-guide/reference-getPasskeys",
        "sdks/embedded-reference-guide/reference-deletePasskey",
        "sdks/embedded-reference-guide/reference-passkey-type",
        "sdks/embedded-reference-guide/reference-getAuthenticationContext",
        "sdks/embedded-reference-guide/reference-authenticateOtp",
        "sdks/embedded-reference-guide/reference-redeemOtp",
      ],
    },
    {
      type: "category",
